...
#define NOTIFICATION_MESSAGE_RECEIVED @"Message Received"
...
- (NSDictionary *) registrationDictionaryForGrowl {
    ...
    NSArray *notifications = [[[NSArray alloc] initWithObjects:NOTIFICATION_MESSAGE_RECEIVED, nil] autorelease];
...
- (void) sendToGrowlTitle:(NSString*)title andDescription:(NSString*)description andIcon:(NSData*)iconData andPriority:(int)priority andSticky:(BOOL)sticky {
    [GrowlApplicationBridge
     ...
     notificationName:NOTIFICATION_MESSAGE_RECEIVED
     iconData:iconData
     priority:priority
     isSticky:sticky
     clickContext:nil];
