...
- (void) setupLightColors {
    ...
    _colorForDirectMessage = [[NSColor colorWithDeviceHue:0.611 saturation:0.3 brightness:1.0 alpha:alpha] retain];
    _colorForHighlightedDirectMessage = [[NSColor colorWithDeviceHue:0.611 saturation:0.55 brightness:1.0 alpha:alpha] retain];
...
- (void) setupDarkColors {
    ...
    _colorForDirectMessage = [[NSColor colorWithDeviceHue:0.611 saturation:0.55 brightness:0.5 alpha:alpha] retain];
