...
- (void) setupLightColors {
    ...
    _colorForDirectMessage = [[NSColor colorWithDeviceHue:0.222 saturation:0.3 brightness:1.0 alpha:alpha] retain];
    _colorForHighlightedDirectMessage = [[_colorForDirectMessage shadowWithLevel:0.5] retain];
...
- (void) setupDarkColors {
    ...
    _colorForDirectMessage = [[NSColor colorWithDeviceHue:0.222 saturation:0.55 brightness:0.5 alpha:alpha] retain];
